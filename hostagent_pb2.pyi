...
class Command(_message.Message):
    __slots__ = ["assign_host", "install", "set_default", "shutdown_host", "start", "stop", "uninstall"]
...
class HostAgentInfo(_message.Message):
    __slots__ = ["hostname", "instances", "token", "uid"]
    ...
    token: str
    uid: str
    def __init__(self, token: _Optional[str] = ..., uid: _Optional[str] = ..., hostname: _Optional[str] = ..., instances: _Optional[_Iterable[_Union[HostAgentInfo.InstanceInfo, _Mapping]]] = ...) -> None: ...
