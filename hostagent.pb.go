...
const file_hostagent_proto_rawDesc = "" +
	...
	"\x13default_instance_id\x18\a \x01(\tH\x01R\x11defaultInstanceId\x88\x01\x01\x12b\n" +
	"\x13unmanaged_instances\x18\b \x03(\v21.landscapehostagentapi.HostAgentInfo.InstanceInfoR\x12unmanagedInstances\x1a\x9e\x01\n" +
	"\fInstanceInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1d\n" +
	"\n" +
	"version_id\x18\x03 \x01(\tR\tversionId\x12K\n" +
	"\x0einstance_state\x18\x04 \x01(\x0e2$.landscapehostagentapi.InstanceStateR\rinstanceStateB\x13\n" +
	...
	"\x11SendCommandStatus\x12$.landscapehostagentapi.CommandStatus\x1a\x1c.landscapehostagentapi.Empty\"\x00B.Z,github.com/canonical/landscape-hostagent-apib\x06proto3"
...
var file_hostagent_proto_depIdxs = []int32{
	...
	6,  // 1: landscapehostagentapi.HostAgentInfo.unmanaged_instances:type_name -> landscapehostagentapi.HostAgentInfo.InstanceInfo
	7,  // 2: landscapehostagentapi.Command.assign_host:type_name -> landscapehostagentapi.Command.AssignHost
	8,  // 3: landscapehostagentapi.Command.start:type_name -> landscapehostagentapi.Command.Start
	9,  // 4: landscapehostagentapi.Command.stop:type_name -> landscapehostagentapi.Command.Stop
	10, // 5: landscapehostagentapi.Command.install:type_name -> landscapehostagentapi.Command.Install
	11, // 6: landscapehostagentapi.Command.uninstall:type_name -> landscapehostagentapi.Command.Uninstall
	12, // 7: landscapehostagentapi.Command.set_default:type_name -> landscapehostagentapi.Command.SetDefault
	13, // 8: landscapehostagentapi.Command.shutdown_host:type_name -> landscapehostagentapi.Command.ShutdownHost
	1,  // 9: landscapehostagentapi.CommandStatus.command_state:type_name -> landscapehostagentapi.CommandState
	0,  // 10: landscapehostagentapi.HostAgentInfo.InstanceInfo.instance_state:type_name -> landscapehostagentapi.InstanceState
	3,  // 11: landscapehostagentapi.LandscapeHostAgent.Connect:input_type -> landscapehostagentapi.HostAgentInfo
	5,  // 12: landscapehostagentapi.LandscapeHostAgent.SendCommandStatus:input_type -> landscapehostagentapi.CommandStatus
	4,  // 13: landscapehostagentapi.LandscapeHostAgent.Connect:output_type -> landscapehostagentapi.Command
	2,  // 14: landscapehostagentapi.LandscapeHostAgent.SendCommandStatus:output_type -> landscapehostagentapi.Empty
