...
type HostAgentInfo_InstanceInfo struct {
	...
	CreatedByLandscape bool                   `protobuf:"varint,5,opt,name=created_by_landscape,json=createdByLandscape,proto3" json:"created_by_landscape,omitempty"`                         // created_by_landscape is indicates this instance was created through an install command from Landscape
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
