...
type Command_Start_ struct {
	Start *Command_Start `protobuf:"bytes,1,opt,name=start,proto3,oneof"`
}

type Command_Stop_ struct {
	Stop *Command_Stop `protobuf:"bytes,2,opt,name=stop,proto3,oneof"`
}

type Command_Install_ struct {
	Install *Command_Install `protobuf:"bytes,3,opt,name=install,proto3,oneof"`
}

type Command_Uninstall_ struct {
	Uninstall *Command_Uninstall `protobuf:"bytes,4,opt,name=uninstall,proto3,oneof"`
}

type Command_SetDefault_ struct {
	SetDefault *Command_SetDefault `protobuf:"bytes,5,opt,name=set_default,json=setDefault,proto3,oneof"`
}

type Command_ShutdownHost_ struct {
	ShutdownHost *Command_ShutdownHost `protobuf:"bytes,6,opt,name=shutdown_host,json=shutdownHost,proto3,oneof"`
}
...
var file_hostagent_proto_rawDesc = []byte{
	...
	0x0d, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x22, 0x81,
	0x05, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x12, 0x3c, 0x0a, 0x05, 0x73, 0x74,
	0x61, 0x72, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x6c, 0x61, 0x6e, 0x64,
	0x73, 0x63, 0x61, 0x70, 0x65, 0x68, 0x6f, 0x73, 0x74, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x61, 0x70,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x6c, 0x61, 0x6e, 0x64, 0x73, 0x63, 0x61,
	...
	0x74, 0x6f, 0x70, 0x12, 0x42, 0x0a, 0x07, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x18, 0x03,
	...
	0x74, 0x61, 0x6c, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x6c, 0x61, 0x6e,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x6c, 0x61, 0x6e, 0x64, 0x73, 0x63, 0x61,
	0x70, 0x65, 0x68, 0x6f, 0x73, 0x74, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x61, 0x70, 0x69, 0x2e, 0x43,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x6c, 0x61, 0x6e, 0x64, 0x73, 0x63, 0x61,
	0x70, 0x65, 0x68, 0x6f, 0x73, 0x74, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x61, 0x70, 0x69, 0x2e, 0x43,
	...
	0x6f, 0x73, 0x74, 0x1a, 0x17, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x72, 0x74, 0x12, 0x0e, 0x0a, 0x02,
...
var file_hostagent_proto_goTypes = []interface{}{
	...
	(*Command_Start)(nil),              // 4: landscapehostagentapi.Command.Start
	(*Command_Stop)(nil),               // 5: landscapehostagentapi.Command.Stop
	(*Command_Install)(nil),            // 6: landscapehostagentapi.Command.Install
	(*Command_Uninstall)(nil),          // 7: landscapehostagentapi.Command.Uninstall
	(*Command_SetDefault)(nil),         // 8: landscapehostagentapi.Command.SetDefault
	(*Command_ShutdownHost)(nil),       // 9: landscapehostagentapi.Command.ShutdownHost
}
var file_hostagent_proto_depIdxs = []int32{
	...
	4, // 1: landscapehostagentapi.Command.start:type_name -> landscapehostagentapi.Command.Start
	5, // 2: landscapehostagentapi.Command.stop:type_name -> landscapehostagentapi.Command.Stop
	6, // 3: landscapehostagentapi.Command.install:type_name -> landscapehostagentapi.Command.Install
	7, // 4: landscapehostagentapi.Command.uninstall:type_name -> landscapehostagentapi.Command.Uninstall
	8, // 5: landscapehostagentapi.Command.set_default:type_name -> landscapehostagentapi.Command.SetDefault
	9, // 6: landscapehostagentapi.Command.shutdown_host:type_name -> landscapehostagentapi.Command.ShutdownHost
	...
	2, // 9: landscapehostagentapi.LandscapeHostAgent.Connect:output_type -> landscapehostagentapi.Command
