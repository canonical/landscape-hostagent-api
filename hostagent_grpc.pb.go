...
func (x *landscapeHostAgentConnectClient) Send(m *Instances) error {
...
func (x *landscapeHostAgentConnectServer) Recv() (*Instances, error) {
	m := new(Instances)
